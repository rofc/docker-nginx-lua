...
RUN git clone https://github.com/simplresty/ngx_devel_kit.git && cd ngx_devel_kit && cd ..
RUN git clone https://github.com/openresty/lua-nginx-module.git && cd lua-nginx-module && cd ..
